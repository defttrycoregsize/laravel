...
use App\Http\Controllers\Auth\{LoginController,ForgotPasswordController,ResetPasswordController,LoginClientController};
...
Route::group(['prefix' => '/','namespace'=>'Client'], function() {
    ...
    Route::get('login', [LoginClientController::class,'showLoginForm'])-> name('client.login');
    Route::post('login', [LoginClientController::class,'customerlogin'])-> name('client.customerlogin');

    Route::get('register', [LoginClientController::class,'register'])-> name('client.register');
