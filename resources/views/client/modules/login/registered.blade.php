...
<div class="wrap-login100 p-l-110 p-r-110 p-t-20 p-b-13">
    <form method="POST" class="login100-form validate-form flex-sb flex-w">
        ...
        <div class="wrap-input100  register-input" data-validate="Yêu cầu nhập đầy đủ Họ và tên của bạn">
            <input placeholder="Họ và tên" class="input100" type="text" name="fullname" value="">
        ...
        <div class="wrap-input100  register-input" data-validate="Yêu cầu nhập Số điện thoại của bạn">
            <input placeholder="Số điện thoại" class="input100" type="tel" name="mobile" value="">
            <span class="focus-input100"></span>
        </div>

        <div class="wrap-input100  register-input" data-validate="Yêu cầu nhập mật khẩu">
            <input placeholder="Mật khẩu, lớn hơn 6 ký tự" class="input100" type="password" name="pass">
            <span class="focus-input100"></span>
        </div>
        ...
        <!-- widget city -->
            ...
            <center>
                <div class="g-recaptcha" data-sitekey="6LcLsycTAAAAABTE6i9OmvP8VvJ-yqWPFZ0JWQ4l"><div style="width: 304px; height: 78px;"><div><iframe src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LcLsycTAAAAABTE6i9OmvP8VvJ-yqWPFZ0JWQ4l&amp;co=aHR0cHM6Ly9pZC51bmljYS52bjo0NDM.&amp;hl=vi&amp;v=NjbyeWjjFy97MXGZ40KrXu3v&amp;size=normal&amp;cb=5u2m1czhflrq" width="304" height="78" role="presentation" name="a-33wkkzr9" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" required="required" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;"></iframe></div>
            </center>
        </div>
        ...
        <div class="p-t-10 p-b-10 col-md-12">
          ...
          <div class="container-login100-form-btn-2">
            <a style="width: 100%;" href="javascript:void(0)" onclick="return login();" class="btn-face m-b-20">
